...
def load_overrides(introspection_module): # -> Any:
...
overridefunc = ...
def deprecated(fn, replacement): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]:
...
def deprecated_init(super_init_func, arg_names, ignore=..., deprecated_aliases=..., deprecated_defaults=..., category=..., stacklevel=...): # -> Callable[..., Any]:
...
def strip_boolean_result(method, exc_type=..., exc_str=..., fail_ret=...): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any | None]:
